...
EXCOL=""
#for splitting
root_dataset_dir="/Users/bing/Documents/mlProfiler/tests/mps/multiinstance/dataset/batch2-8/MPS100/trainratio_${n_occur}"
...
then
    ...
    do
        ...
        outdir_rand="$outdir/trainratio_${n_occur}/rand${seed}/$modeltype"
        mkdir -p $dataset_dir
        mkdir -p $outdir_rand
        ...
        --output_dir $outdir_rand --modeltype $modeltype -comb 3 
    done
fi
...
#Predict throughput for different workloads
    ...
    do
        ...
        do
            ...
            echo "seed $seed"
            dataset_dir="$root_dataset_dir/rand${seed}"
            model_dir="$outdir/trainratio_${n_occur}/rand${seed}/$modeltype"
            outdir_rand="$outdir/trainratio_${n_occur}/rand${seed}/$modeltype/$workload"
