...
then
    full_data_path="/Users/bing/Documents/mlProfiler/tests/mps/multiinstance/dataset/hotcloud/0912hotcloud_gpt2xl_batchedthroughput_total_labels_comb2_batch2-8_targetMPS100.csv"
else
    #KACE
    ...
    full_data_path="./dataset/KACE/0912_batchedthroughput_total_labels_comb2_autoregression_batch1_outputlen20_100_214_targetMPS100.csv"
fi
...
'albert-base-v2_batch8-train'
'bert-base-cased_batch2-train'
'whisper-large-v2_batch16-inf'
'bert-base-cased_batch16-inf'
'vit-base-patch16-224_batch16-inf'
'wav2vec2-base-960h_batch16-inf'
'bert-base-cased_batch16-train'
'vit_h_14_batch16-train'
'albert-base-v2_batch16-train'
)
    ...
    do
        ...
        do
            ...
            then
                ...
                $full_data_path $workload $dataset_dir $n_combination
