...
#CONFIGS modify if needed:
############################################
#EXCOL="_Static Shared Memory"
EXCOL=""
#for splitting
root_dataset_dir="/Users/bing/Documents/mlProfiler/output/dataset/MPS100/partition_exp/n_occur_${n_occur}"
...
then
    ...
    #KACE
    full_data_path="/Users/bing/Library/CloudStorage/OneDrive-StonyBrookUniversity/SBU/mlsys/mlProfiler/output/dataset/MPS100/MPS100_kernel_labels_targetMPS100.csv"
fi
...
#workloads=( 'whisper-large-v2_batch16-inf' )
...
then
    ...
    for seed in "${seeds[@]}"
        do
            ...
            outdir_rand="$outdir/n_occur_${n_occur}/rand${seed}/$modeltype/$workload"
            mkdir -p $dataset_dir
            mkdir -p $outdir_rand
            ...
            then
                ...
                $full_data_path $workload $dataset_dir
