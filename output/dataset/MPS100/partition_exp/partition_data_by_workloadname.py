...
def partition_dataset(filename, test_workload_name, outputdir, n_combination, split_test_only):
    ...
    # Extract the base name and task of the workload to match any batch size variants
    base_workload_name = test_workload_name.split('_batch')[0]
    task = test_workload_name.split('_batch')[1].split('-')[1]
    ...
    train_mask = ~exact_test_mask & ~exclude_workload_task_mask
